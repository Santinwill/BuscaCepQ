...
initialization
  ...
  InvRegistry.RegisterMethodInfo(TypeInfo(AtendeCliente), 'consultaCEP', '', '[ReturnName="return"]', IS_OPTN or IS_UNQL);
  InvRegistry.RegisterParamInfo(TypeInfo(AtendeCliente), 'consultaCEP', 'cep', '', '', IS_UNQL);
  InvRegistry.RegisterParamInfo(TypeInfo(AtendeCliente), 'consultaCEP', 'return', '', '', IS_UNQL);
